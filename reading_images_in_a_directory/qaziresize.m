 ...
 inputDir = 'qazipics/'; % this is the input directory
 outputDir = 'qazioutputpics/';% after processing all the jpg images will be stored into png format in this directory
